...
export default {
  ...
  methods: {
    onSubmit() {
      axios.get('sub/userInfo/register?username=' + this.form.username + '&password=' + this.form.password).then((res) => {
...
#register {
  width: 100%;
  height: 100vh;
  background: url('../../assets/images/register/reg.jpg') no-repeat;
